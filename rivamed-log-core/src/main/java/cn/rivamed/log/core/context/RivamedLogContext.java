...
public class RivamedLogContext {
    ...
    private static final TransmittableThreadLocal<String> tenantIdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> tokenIdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> userIdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> userNameTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> deviceIdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> snTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> bizIdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> bizProdTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> bizActionTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> responseCodeTTL = new TransmittableThreadLocal<>();

    private static final TransmittableThreadLocal<String> logRecordTTL = new TransmittableThreadLocal<>();
