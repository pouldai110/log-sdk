...
public class RivamedLogRPCContext {
    ...
    public static void setHasTLogMDC(boolean hasTLogMDC) {
        RivamedLogRPCContext.hasTLogMDC = hasTLogMDC;
    }
    ...
    public static void setEnableInvokeTimePrint(boolean enableInvokeTimePrint) {
        RivamedLogRPCContext.enableInvokeTimePrint = enableInvokeTimePrint;
    }
    ...
    public static void setHasLogstash(boolean hasLogstash) {
        RivamedLogRPCContext.hasLogstash = hasLogstash;
    }
}
