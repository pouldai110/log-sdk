 ...
 */
package cn.rivamed.log.spring.appender;
 ...
 * intervals.
 */
@Plugin(name = "RivamedRollingRandomAccessFileAppender", category = Core.CATEGORY_NAME, elementType = Appender.ELEMENT_TYPE, printObject = true)
public final class RivamedRollingRandomAccessFileAppender extends AbstractOutputStreamAppender<RollingRandomAccessFileManager> {

    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<RivamedRollingRandomAccessFileAppender> {
        ...
        @PluginBuilderAttribute("sysName")
        ...
        @Override
        public RivamedRollingRandomAccessFileAppender build() {
            ...
            return new RivamedRollingRandomAccessFileAppender(name, layout, getFilter(), manager, fileName, sysName, filePattern,
        ...
        public B withSysName(final String sysName) {
    ...
    private RivamedRollingRandomAccessFileAppender(final String name, final Layout<? extends Serializable> layout,
                                                   final Filter filter, final RollingRandomAccessFileManager manager, final String fileName, final String sysName,
    ...
    public void append(final LogEvent logEvent) {
        ...
        manager.checkRollover(logEvent);
        ...
        manager.setEndOfBatch(logEvent.isEndOfBatch()); // FIXME manager's EndOfBatch threadlocal can be deleted

        // LOG4J2-1292 utilize gc-free Layout.encode() method: taken care of in superclass
        super.append(logEvent);

        if (disruptorPushService == null) {
            try {
                disruptorPushService = RivamedLogSpringContextHolder.getBean(DisruptorPushService.class);
            } catch (Exception e) {
            }
        } else {
    ...
    /**
     * Returns the system name for the Appender.
     *
     ...
     */
    @Deprecated
    public static <B extends Builder<B>> RivamedRollingRandomAccessFileAppender createAppender(
        ...
        return RivamedRollingRandomAccessFileAppender.<B>newBuilder()
